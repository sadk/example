...
import activiti.FinancialTest.JumpTaskCmd;

public class EnergyBusinessPlanTest {
	private static String KEY_能耗业务计划="energyBusinessPlan" ;
	...
	public static void deploy() {
		Deployment dep = ActUtil.getRepositoryService().createDeployment().addClasspathResource("diagrams/energy_job_plan.bpmn")
				.name("能耗流程").category("办公流程").tenantId("1000").deploy();
