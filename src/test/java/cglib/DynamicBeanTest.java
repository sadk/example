...
public class DynamicBeanTest {
	...
	public DynamicBeanTest(Object sourceBean,Map<String,Class<?>> propertyMap) {
	 ...
	 * @throws Exception 
	 */
	public DynamicBeanTest buildTargetBean() throws Exception {
		// 1.源对象属性利用反射拷贝
		Class<?> type = sourceBean.getClass();
	...
	public DynamicBeanTest appendTargetPropertyValue(Map<String,Object> propValue) {
	...
	public static void main(String[] args) throws Exception {
		...
		Object bean = new DynamicBeanTest(query,propertyMap)
				.buildTargetBean()
				.appendTargetPropertyValue(propertyValue)
				.toFinalBean();
