 ...
 *
 */
@Controller(mapping = { "/act/process_instance_his","/nv2/act/process_instance_his" })
public class ProcessInstanceHisController {
	@Inject private Db db;
	@Inject private PlatformDb db2;
	 
	@RequestMapping(mapping = { "/page", "/m/page" }, text = "获取已结束的流程实例（含流程标题、发起人、业务主键等关键信息)")
