...
public class UserEntryInfo {
	...
	public static int ENTRY_STATUS_银行卡是被状态_成功=160;
	public static int ENTRY_STATUS_银行卡是被状态_失败=161;
	
	public static int ENTRY_STATUS_审核某步骤失败=300; // 三步流程是：身份证扫描-》人脸识别-》银行卡号扫描
