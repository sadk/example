...
public class UserController {
	...
	public User saveOrUpdateShort(User form) {
		form.setTenantCode(ContextUtil.getLoginTenantCode());
		db.saveOrUpdate(form, "realName","nickName","sex","birthday","phone","email","seatNumber","education","entryStatus","roleName","roleCode","dependCompanyName","dependCompanyCode");
		return form;
	}
