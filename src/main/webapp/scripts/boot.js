...
document.write('<script src="' + bootPATH + 'authentication.js" type="text/javascript"></sc' + 'ript>');
...
//添加自定的工具类JS
document.write('<script src="' + bootPATH + 'commonUtil.js" type="text/javascript" ></sc' + 'ript>');
