	...
	<body> 
		            ...
		            <div style="padding:5px;">
				        <table>
							<tr> 
								...
								<td style="width:150px;">
									<input name="idcard" id="idcard" class="mini-textbox" />
								</td>
							</tr>
				        </table>
				    </div>
		...
		<script type="text/javascript">
			...
			function SaveData() {
				...
				$.ajax({
					url : "${pageContext.request.contextPath}/chk/user_crime/save_or_update",
					dataType: 'json',
					type : 'post',
					cache : false,
					data: form.getData(),
			...
			function SetData(data) {
				data = mini.clone(data); //跨页面传递的数据对象，克隆后才可以安全使用
				 ...
				 if(data.action == "edit" || data.action=='view') {
					$.ajax({
						url : "${pageContext.request.contextPath}/chk/user_crime/page?id=" + data.id,
						dataType: 'json',
						cache : false,
						success : function(text) {
