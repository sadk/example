...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="mini-splitter" style="width:100%;height:100%;">
			...
			<div showCollapseButton="true">
				...
				<div class="mini-fit">
					...
					url="${pageContext.request.contextPath}/tags/page"  idField="id" sizeList="[20,50,100,150,200]" pageSize="50" >
					<div property="columns">
						<div type="checkcolumn" ></div>
						<div field="name" width="80" headerAlign="center" allowSort="true" align="left" >名称</div>
						<div field="code" width="100" headerAlign="center" allowSort="true" align="left" >编码</div>
						<div field="value" width="100" headerAlign="center" allowSort="true" align="left" >标签值</div>
		...
		function remove() {
			...
			mini.confirm("确定删除？", "确定？",
				function (action) {
					if (action == "ok") {
						$.ajax({
							'url': "${pageContext.request.contextPath}/tags/delete?ids="+ids.join(","),
							type: 'post',
							dataType:'JSON',
							cache: false,
							async:false,
		...
		function add() {
			mini.open({
				url : "${pageContext.request.contextPath}/apps/default/admin/cms/tags/edit.jsp",
				title : "添加资讯",
				width : 790,
				height : 600,
				onload : function() {
