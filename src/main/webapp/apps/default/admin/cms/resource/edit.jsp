	...
	<body> 
		            ...
		            <div style="padding:5px;">
				        <table>
							<tr>
								...
								<td style="width:150px;">
									<input name="alias" id="alias" class="mini-textbox" emptyText="请输入简称"/>
								</td>
							</tr>
							<tr>
								<td>文件编码：</td>
								...
								<td>上级目录：</td>
								<td>
								 	<input id="pid" name="pid" class="mini-buttonedit" onbuttonclick="onButtonEdit" emptyText="根目录可以为空"/>    
								</td>
							</tr>
		...
		<script type="text/javascript">
	        ...
	        function onButtonEdit(e) {
	            ...
	            //alert(idNotIn);
	            mini.open({
	                url: "${pageContext.request.contextPath}/apps/default/admin/cms/resource/selector.jsp?idNotIn="+idNotIn,
	                title: "选择列表",
	                width: 650,
	                height: 380,
			...
			function SetData(data) {
				data = mini.clone(data); //跨页面传递的数据对象，克隆后才可以安全使用
				 if(data.action == "add" ) {
					...
					mini.get("pid").setText(data.parentName);
					
					mini.get("appCode").setValue(data.appCode);
					console.log(data)
					return ; 
				 } 
