					...
					<div id="hr_user_salary" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" multiSelect="true" showPager="true"  sizeList="[20,30,500]"  pageSize="20" 
						...
						<div property="columns">
							<div type="checkcolumn" ></div>
									...
									<div type="comboboxcolumn" field="sex" width="120" headerAlign="center" visible="false" align="center" >性别
									...
									<div field="remark" width="120" headerAlign="center" visible="true"   align="center" >备注</div>
									<div field="appCode" width="120" headerAlign="center" visible="true"   align="center" >所属应用</div>
									<div field="gid" width="120" headerAlign="center" visible="true"   align="center" >全局ID</div>
									...
									<div field="sn" width="120" headerAlign="center" visible="true"   align="center" >排序号</div>
									<div field="birthday" width="120" headerAlign="center" visible="true"   align="center" >生日</div>
						</div>
					</div>
		        </div>
