...
<div class="mini-splitter" style="width:100%;height:100%;">
				...
				<div id="form1"  style="padding:8px;">
					<table>	
						...
						<tr>
							<td>关键字 ：</td>
							<td>
								<input id="reportDefinitionId" name="reportDefinitionId" class="mini-hidden" value="8"/>
						 ...
						 -->
									...
									<tr>
										<td>create_time(开始)：</td>
										<td>
											<input id="createTimeBegin" name="createTimeBegin" class="mini-datepicker" style="width:140px;" nullValue="null"  format="yyyy-MM-dd" timeFormat="HH:mm:ss"  showTime="true" showOkButton="true" showClearButton="false"  emptyText="请输入" required="true" />
										</td>
									</tr>
									<tr>
										<td>create_time(结束)：</td>
										<td>
											<input id="createTimeEnd" name="createTimeEnd" class="mini-datepicker" style="width:140px;" nullValue="null"  format="yyyy-MM-dd" timeFormat="HH:mm:ss"  showTime="true" showOkButton="true" showClearButton="false"  emptyText="请输入" required="true" />
										</td>
									</tr>
									...
									<tr>
										<td>contract_no：</td>
										<td>
											<input id="contractNo" name="contractNo"  style="width:140px" class="mini-textbox"  emptyText="请输入contract_no"  onenter="search"  />
										</td>
									</tr>
    ...
    <div showCollapseButton="true">
    	<div id="tabs1" class="mini-tabs" activeIndex="0" plain="false" style="width:100%;height:100%;" bodyStyle="padding:0;border:0;">
  			...
  			<div title="代扣结果查询">
		        ...
		        <div class="mini-fit" >
					<div id="report_daikou_result_query" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" multiSelect="true" 
							showPager="true"  
						...
						<div property="columns">
							<div type="checkcolumn" ></div>
									...
									<div field="lasserialNo" width="120" headerAlign="center" visible="true"   align="center" >lasserial_no</div>
									...
									<div field="contractNo" width="120" headerAlign="center" visible="true"   align="center" >contract_no</div>
									...
									<div field="status" width="120" headerAlign="center" visible="true"   align="center" >status</div>
									...
									<div field="resultInfo" width="120" headerAlign="center" visible="true"   align="center" >result_info</div>
									<div field="result" width="120" headerAlign="center" visible="true"   align="center" >result</div>
									...
									<div field="outBatNo" width="120" headerAlign="center" visible="true"   align="center" >out_bat_no</div>
									<div field="dkCode" width="120" headerAlign="center" visible="true"   align="center" >dk_code</div>
									<div field="dkChannel" width="120" headerAlign="center" visible="true"   align="center" >dk_channel</div>
						</div>
					</div>
		        </div>
		    </div>    
    ...
    mini.parse();
	var grid = mini.get("report_daikou_result_query");
	...
	function exportData() {
		...
		if(form.isValid() == false) return;
		    			...
		    			data.createTimeBegin =  mini.get('createTimeBegin').text;
		    			data.createTimeEnd =  mini.get('createTimeEnd').text;
		
		 	data.pageIndex = grid.pageIndex;
		 	data.pageSize = grid.pageSize;
		data.reportDefinitionId=8;
