...
<div class="mini-splitter" style="width:100%;height:100%;">
				...
				<div id="form1"  style="padding:8px;">
					<table>	
						...
						<tr>
							<td>关键字 ：</td>
							<td>
								<input id="reportDefinitionId" name="reportDefinitionId" class="mini-hidden" value="1007"/>
    ...
    <div showCollapseButton="true">
    	<div id="tabs1" class="mini-tabs" activeIndex="0" plain="false" style="width:100%;height:100%;" bodyStyle="padding:0;border:0;">
  			...
  			<div title="累计到期表">
		        ...
		        <div class="mini-fit" >
					<div id="bi_report_ljdqb" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" multiSelect="true" 
							showPager="true"  
							
									sizeList="[20,50,100,50000]" 
						...
						<div property="columns">
							<div type="checkcolumn" ></div>
									...
									<div field="BDFF" width="120" headerAlign="center" visible="true"   align="center" >被担保方</div>
    ...
    mini.parse();
	var grid = mini.get("bi_report_ljdqb");
	var form = new mini.Form("form1");
	

	function ajaxGetTemplateExists(type,callback) {
		var data = {};
		data.definitionId= '1007';
