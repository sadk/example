...
<div class="mini-splitter" style="width:100%;height:100%;">
				...
				<div id="form1"  style="padding:8px;">
					<table>	
						...
						<tr>
							<td>关键字 ：</td>
							<td>
								<input id="reportDefinitionId" name="reportDefinitionId" class="mini-hidden" value="1003"/>
    ...
    <div showCollapseButton="true">
    	<div id="tabs1" class="mini-tabs" activeIndex="0" plain="false" style="width:100%;height:100%;" bodyStyle="padding:0;border:0;">
  			...
  			<div title="当期_未到期">
		        ...
		        <div class="mini-fit" >
					<div id="bi_report_dqwdq" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" multiSelect="true" 
							showPager="true"  
						...
						<div property="columns">
							<div type="checkcolumn" ></div>
									...
									<div field="PAYDATE" width="120" headerAlign="center" visible="true"   align="center" >支付日期</div>
									...
									<div field="DKLX" width="120" headerAlign="center" visible="true"   align="center" >贷款类型</div>
									...
									<div field="WDQBJ" width="120" headerAlign="center" visible="true"   align="center" >未到期本金</div>
									<div field="WDQLX" width="120" headerAlign="center" visible="true"   align="center" >未到期利息</div>
    ...
    mini.parse();
	var grid = mini.get("bi_report_dqwdq");
	var form = new mini.Form("form1");
	

	function ajaxGetTemplateExists(type,callback) {
		var data = {};
		data.definitionId= '1003';
