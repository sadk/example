...
<div class="mini-splitter" style="width:100%;height:100%;">
				...
				<div id="form1"  style="padding:8px;">
					<table>	
						...
						<tr>
							<td>关键字 ：</td>
							<td>
								<input id="reportDefinitionId" name="reportDefinitionId" class="mini-hidden" value="1001"/>
						 ...
						 -->
									...
									<tr>
										<td>应还款月(开始)：</td>
										<td>
											<input id="PAYDATEBegin" name="PAYDATEBegin" class="mini-datepicker" style="width:140px;" nullValue="null"  format="yyyy/MM/dd" timeFormat="HH:mm:ss"  showTime="true" showOkButton="true" showClearButton="false"  emptyText="请输入" required="true" />
										</td>
									</tr>
									<tr>
										<td>应还款月(结束)：</td>
										<td>
											<input id="PAYDATEEnd" name="PAYDATEEnd" class="mini-datepicker" style="width:140px;" nullValue="null"  format="yyyy/MM/dd" timeFormat="HH:mm:ss"  showTime="true" showOkButton="true" showClearButton="false"  emptyText="请输入" required="true" />
										</td>
									</tr>
    ...
    <div showCollapseButton="true">
    	<div id="tabs1" class="mini-tabs" activeIndex="0" plain="false" style="width:100%;height:100%;" bodyStyle="padding:0;border:0;">
  			...
  			<div title="当期_到期表">
		        ...
		        <div class="mini-fit" >
					<div id="bi_report_dqdqb" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" multiSelect="true" 
							showPager="true"  
						...
						<div property="columns">
							<div type="checkcolumn" ></div>
									...
									<div field="HXRQ" width="120" headerAlign="center" visible="true"   align="center" >核消日期</div>
									...
									<div field="PAYDATE" width="120" headerAlign="center" visible="true"   align="center" >应还款月</div>
									<div field="SEQID" width="120" headerAlign="center" visible="true"   align="center" >期次</div>
									<div field="SFQXFQQC" width="120" headerAlign="center" visible="true"   align="center" >是否取消分期期次</div>
									...
									<div field="YHBJ" width="120" headerAlign="center" visible="true"   align="center" >应还本金</div>
									<div field="YHLX" width="120" headerAlign="center" visible="true"   align="center" >应还利息</div>
									<div field="YHZHGLF" width="120" headerAlign="center" visible="true"   align="center" >应还账户管理费</div>
									<div field="YHZZFWF" width="120" headerAlign="center" visible="true"   align="center" >应还增值服务费</div>
									<div field="YHTQHKSXF" width="120" headerAlign="center" visible="true"   align="center" >应还提前还款手续费</div>
									<div field="YHZNJ" width="120" headerAlign="center" visible="true"   align="center" >应还滞纳金</div>
									<div field="YHCSF" width="120" headerAlign="center" visible="true"   align="center" >应还催收费</div>
									<div field="YHTQCSF" width="120" headerAlign="center" visible="true"   align="center" >应还提前催收费</div>
									<div field="YHYHS" width="120" headerAlign="center" visible="true"   align="center" >应还印花税</div>
    ...
    mini.parse();
	var grid = mini.get("bi_report_dqdqb");
	var form = new mini.Form("form1");
	

	function ajaxGetTemplateExists(type,callback) {
		var data = {};
		data.definitionId= '1001';
	...
	function exportData() {
		...
		if(form.isValid() == false) return;
		    			...
		    			data.PAYDATEBegin =  mini.get('PAYDATEBegin').text;
		    			data.PAYDATEEnd =  mini.get('PAYDATEEnd').text;
		
		 	data.pageIndex = grid.pageIndex;
		 	data.pageSize = grid.pageSize;
		data.reportDefinitionId=1001;
