	...
	<body> 
		<form id="edit-form1" method="post" style="height:97%; overflow:auto;">
			...
			<div style="padding:4px;padding-bottom:5px;">
		            ...
		            <div style="padding:5px;">
				        <table>
							...
							<tr>
								...
								<td>数据类型：</td>
								<td>
								 	<input name="javaType" id="javaType" class="mini-combobox" required="true" showNullItem="true" nullItemText="请选择..." emptyText="请选择" textField="name" valueField="value" url="${pageContext.request.contextPath}/dictionary/option?code=java_type" />
								</td>
							</tr>
				...
				<fieldset id="sqlMapping" style="border:solid 1px #aaa;padding:3px; margin-bottom:5px;">
		            <legend>SQL映射</legend>
		            <div style="padding:5px;">
				        <table>
							<tr>
				...
				<fieldset id="searchAreaControlGenrate" style="border:solid 1px #aaa;padding:3px; margin-bottom:5px;">
				...
				<fieldset id="searchControlConfig" style="border:solid 1px #aaa;padding:3px; margin-bottom:5px;" id="controlConfig">
				...
				<fieldset id="dataAreaTableShow" style="border:solid 1px #aaa;padding:3px; margin-bottom:5px;" id="controlConfig">
		...
		<script type="text/javascript">
			...
			function SaveData() {
				...
				o.searchType = 0; //是否作为查询条件
				o.searchRequired = 0; //是否查询必填
			...
			function SetData(data) {
				...
				var searchType = mini.get("searchType") ;
				var searchRequired = mini.get("searchRequired");
				
				searchType.setValue(0);
				searchRequired.setValue(0);
				...
				if (data.action == 'add') {
					...
					$("#searchAreaControlGenrate").hide();
					$("#searchControlConfig").hide();
					$("#dataAreaTableShow").hide();
					$("#sqlMapping").hide();
					
				}
				 if(data.action == "edit" || data.action=='view' || data.action == "editImport") {
					$.ajax({
