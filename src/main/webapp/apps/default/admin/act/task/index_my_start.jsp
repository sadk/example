...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
				...
				<div class="mini-splitter" vertical="true" style="width:100%;height:100%;">
					<div size="50%" showCollapseButton="true">
						<div id="tabs1"  class="mini-tabs" activeIndex="0" style="width:100%;height:100%;" bodyStyle="padding:0;border:0;">
						    ...
						    <div title="我的发起" refreshOnClick="true">
						        ...
						        <div class="mini-fit">
									<div id="myStartedGrid" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" multiSelect="true" 
		...
		<script type="text/javascript">
			...
			var grid = mini.get("myStartedGrid")
