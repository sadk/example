	...
	<body>
		<div class="mini-splitter" style="width:100%;height:100%;">
			<div size="240" showCollapseButton="true">
		        ...
		        <div class="mini-fit">
		            <ul id="tree1" class="mini-tree" url="${pageContext.request.contextPath}/act/category/all?dataType=3" style="width:100%;"
		...
		function add() {
			mini.open({
				url : "${pageContext.request.contextPath}/apps/default/admin/act/variable/edit.jsp",
				title : "添加变量",
				width : 490,
				height : 250,
				onload : function() {
