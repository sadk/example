...
<body>
    ...
    <div class="mini-fit">
		<div id="datagrid1" class="mini-treegrid"" style="width:100%;height:100%;"
		    ...
		    <div property="columns">
		        ...
		        <div field="code" width="80" align="left">账号</div>
	...
	<script type="text/javascript">
		...
		function SetData(data) {
			...
			if(data) {
				...
				createDeptId = data.createDeptId;
				 var url = "${pageContext.request.contextPath}/act/node_user/view_user?definitionId=" + data.definitionId+"&taskKey="+data.taskKey+"&loginUserId="+data.loginUserId+"&createDeptId="+data.createDeptId;
				 grid.setUrl(url);
	    ...
	    function ajaxLoad() {
	    	grid.loading("加载中，请稍后......");
	    	var url = "${pageContext.request.contextPath}/act/node_user/view_user?definitionId=" + definitionId+"&taskKey="+taskKey+"&loginUserId="+loginUserId;
            $.ajax({
                url: url,
                type: "post",
