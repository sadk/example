	...
	<body> 
		<form id="edit-form1" method="post" style="height:97%; overflow:auto;">
			...
			<div style="padding-left:11px;padding-bottom:5px;">
				...
				<fieldset style="border:solid 1px #aaa;padding:3px; margin-bottom:5px;">
		            <legend>2. 选择流程版本</legend>
		            <div style="padding:5px;">
				        <table>
				        	<tr>
								<td style="width:100px;">历史版本：</td>
								<td style="width:400px;" colspan="3">
								 	<input width="314px" id="hisDefinitionId" name="hisDefinitionId" class="mini-buttonedit" onbuttonclick="onVersionButtonEdit" required="true"/>    
								</td>
							</tr>
 							<tr>
 								<td>流程版本:</td>
 								<td colspan="3"><input  width="314px" class="mini-textbox"  name="hisVersion" id="hisVersion" readonly="readonly"/></td>
 							</tr>
				        </table>
				    </div>
				</fieldset>
		...
		<script type="text/javascript">
	        ...
	        function onVersionButtonEdit(e) {
	            var btnEdit = this;
	            mini.open({
	                url: "${pageContext.request.contextPath}/apps/default/admin/act/definition/selector_definition_tree.jsp",
	                title: "选择列表",
	                width: 800,
	                height: 600,
	                ondestroy: function (action) {
	                    ...
	                    if (action == "ok") {
	                        ...
	                        if (data) {
	                            ...
	                            mini.get("hisVersion").setValue(data.version+"");
	                        }
	                    }
			...
			function SaveData() {
				...
				//if(true) return ;
				$.ajax({
					url : "${pageContext.request.contextPath}/act/definition/deploy_copy_settings",
					dataType: 'json',
					type : 'post',
					cache : false,
					data: form.getData(),
