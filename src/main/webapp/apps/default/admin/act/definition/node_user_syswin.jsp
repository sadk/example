...
<div class="mini-splitter" style="width:100%;height:100%;">
    <div size="240" showCollapseButton="true">
        ...
        <div class="mini-fit">
            <ul id="tree1" class="mini-tree" url="${pageContext.request.contextPath}/dictionary/option?code=enterprise_card_node" style="width:100%;"
		        ...
		        <div class="mini-fit" >
					...
					url="${pageContext.request.contextPath}/act/user_data_config/org_list" > 
					    <div property="columns">
					        ...
					        <div name="code" field="code" width="80" headerAlign="center">编码</div><!-- orgUnitId -->
  			...
  			<div title="用户" >
		        ...
		        <div class="mini-fit" >
		            <div id="dataGridUser" class="mini-datagrid" style="width:100%;height:100%;" multiSelect="true" 
		                ...
		                showFilterRow="false" allowCellSelect="true" allowCellEdit="true" showPager="false">
		                <div property="columns">
		                	<div type="checkcolumn"></div>   
		                	<div field="id" width="80" headerAlign="center" allowSort="true">用户ID</div>           
					        ...
					        <div name="remark" field="remark" width="200" >备注</div>
		        ...
		        <div class="mini-fit" >
		            <div id="dataGridApprove" class="mini-datagrid" style="width:100%;height:100%;" multiSelect="true" 
		                ...
		                <div property="columns">
		                    ...
		                    <div field="name" width="120" headerAlign="center" allowSort="true">名称</div>
		                    <div field="approveObjectJson" width="80" align="center">审批对象值
    ...
    <script type="text/javascript">
		...
		tree.on("nodeclick",function(e){
			dataGridOrg.clearRows();
			dataGridUser.clearRows();
			dataGridPosition.clearRows();
		...
		function saveAsApprove() {
			...
			//row.organizationId = row.value;
			//console.log(mini.encode(row));
			...
			if(row) {
				...
				data.push({approveObjectId: row.id ,approveObjectJson: mini.encode(row), definitionId:definitionId,definitionName:definitionName,taskKey:taskKey,name:row.name,userType:3,userFromType:1})
			...
			if(rows && rows.length>0) {
				for(var i=0;i<rows.length;i++) {
					var obj = mini.clone(rows[i]);
					
					obj.organizationId = tree.getSelected().value;
					
					//console.log(mini.encode(obj));
					
					data.push({approveObjectId: rows[i].id ,approveObjectJson: mini.encode(obj), definitionId:definitionId,definitionName:definitionName,taskKey:taskKey,name:rows[i].name,userType:2,userFromType:1})
				}
			}
			
			// 用户
			var rows = dataGridUser.getSelecteds();
			if(rows && rows.length>0) {
				for(var i=0;i<rows.length;i++) {
					var obj = mini.clone(rows[i]);
					obj.organizationId = tree.getSelected().value;
					
					data.push({approveObjectId: rows[i].id ,approveObjectJson : mini.encode(obj),definitionId:definitionId,definitionName:definitionName,taskKey:taskKey,name:rows[i].name,userType:5,userFromType:1})
				}
			}
