...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body> 
		<form id="edit-form1" method="post" style="height:97%; overflow:auto;">
			...
			<input name="templateId" id="templateId" class="mini-hidden" />
		...
		<script type="text/javascript">
			...
			var templateId = mini.get("templateId");
			...
			function SaveData() {
				...
				$.ajax({
					url : "${pageContext.request.contextPath}/rst/contract_template_variable/save_or_update",
			...
			function SetData(data) {
				...
				templateId.setValue(data.templateId);
				 ...
				 if(data.action == "edit") {
					...
					$.ajax({
						url : "${pageContext.request.contextPath}/rst/contract_template_variable/get_by_id?id=" + data.id,
						dataType: 'json',
						success : function(text) {
