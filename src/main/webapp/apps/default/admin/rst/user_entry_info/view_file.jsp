...
<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
    <div  title="员工简要信息、OCR与人脸识别影像文件" region="north" height="100" showSplitIcon="false" >
							        ...
							        <table style="width:100%;" border="0">
										<tr>
											...
											<td style="width:200px">
												<input id="idCard" name="idCard"  class="mini-textbox"   allowInput="false"  />
											</td>
										</tr>
										<tr>
											...
											<td>所属门店</td>
											<td>
												<input id="storeName" name="storeName"  class="mini-textbox"   allowInput="false" />
											</td>
	 ...
	 <div title="south" region="south" showSplit="false" showHeader="false" height="36" showSplitIcon="false" > 
			<div id="subbtn" style="text-align:center;padding:4px;"> 
				<a class="mini-button" iconCls="icon-ok" onclick="onOk" style="width:100px;margin-right:20px;">审核提交</a>
				<a class="mini-button" iconCls="icon-cancel" onclick="onCancel" style="width:80px;">关闭</a> 
			</div>
    </div>  
