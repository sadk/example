				...
				<div class="mini-fit">
					<div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="false" multiSelect="true" autoLoad="false"
						...
						<div property="columns">
							...
							<div type="comboboxcolumn" field="sex" width="160" headerAlign="center" align="left" allowSort="true">性别
								<input property="editor" class="mini-combobox" showNullItem="true" nullItemText="请选择..." emptyText="请选择" textField="name" valueField="value" url="${pageContext.request.contextPath}/dictionary/option?code=sex" />
							</div>
							<div field="idCard" width="100" headerAlign="center" allowSort="true" align="center">身份证</div>
							
							<div field="faceDetect" width="100" headerAlign="center" allowSort="true" align="center">认证结果</div>
							
							<div type="comboboxcolumn" field="entryStatus" width="160" headerAlign="center" align="left" allowSort="true">入职状态
							...
							<div field="entryTime" dateFormat="yyyy-MM-dd HH:mm:ss" width="160" headerAlign="center" allowSort="true" align="center">入职日期</div>
							<div field="storeName" width="160" headerAlign="center" allowSort="true" align="left">所属门店</div>
