...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
				...
				<div class="mini-splitter" vertical="true" style="width:100%;height:100%;">
					<div size="50%" showCollapseButton="true">
						<div id="tabs1" contextMenu="#refreshTabMenu"  class="mini-tabs" activeIndex="0" style="width:100%;height:100%;" bodyStyle="padding:0;border:0;">
						    <div title="角色" refreshOnClick="true">
						        ...
						        <div class="mini-fit">
						            <div id="roleGrid" class="mini-datagrid" style="width:100%;height:100%;" showReloadButton="true"
						                url="${pageContext.request.contextPath}/role/page" idField="id" allowResize="false"
					...
					<div showCollapseButton="true">
						<div id="tabs2" contextMenu="#refreshTabMenu" class="mini-tabs" activeIndex="0" style="width:100%;height:100%;" bodyStyle="padding:0;border:0;">
							...
							<div title="角色下用户列表" refreshOnClick="true" name="tabUserReses">
								<div class="mini-toolbar" style="border-bottom:0;padding:0px;">
									<table style="width:100%;">
										<tr>
											<td style="width:100%;">
							...
							<div title="角色下的资源列表" refreshOnClick="true" name="tabReses">
								<div class="mini-toolbar" style="border-bottom:0;padding:0px;">
									<table style="width:100%;">
										<tr>
											<td style="width:100%;">
												<a class="mini-button" iconCls="icon-add" onclick="addRes()">添加资源</a>
												<a class="mini-button" iconCls="icon-remove" onclick="removeRes()">移出资源</a>
											</td>
											<td style="white-space:nowrap;">
						                        <input id="key_oro" name="key_oro" class="mini-textbox" emptyText="请输入关键字" style="width:150px;" onenter="search"/>   
						                        <a class="mini-button" onclick="search('oro')">搜索</a>
		...
		<script type="text/javascript">
			...
			var grid = mini.get("roleGrid"); // 角色列表
			var userGrid = mini.get("userGrid");// 角色下的用户
			var resGrid = mini.get("resGrid"); //  角色下的资源
			...
			grid.on("rowclick", function(e){
				var record = e.record;
				userGrid.load({roleId:record.id}); //角色下的用户
				resGrid.load({roleIds:record.id+""}); //角色下的资源
			});
