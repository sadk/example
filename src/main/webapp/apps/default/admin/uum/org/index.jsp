		...
		<div class="mini-splitter" style="width:100%;height:100%;">
			...
			<div showCollapseButton="true">
				...
				<div class="mini-fit">
					...
					url="${pageContext.request.contextPath}/org/all" > 
		...
		function exportData() {
			...
			mini.confirm("确定导出记录？", "确定？",
		            function (action) {
		                if (action == "ok") {
		    				var o = form.getData();
							var url = "${pageContext.request.contextPath}/org/export?exportFileType="+exportFileType+"&exportDataType="+exportDataType;
							location.href=url;
						}
					});
