...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="mini-splitter" style="width:100%;height:100%;">
			...
			<div showCollapseButton="true">
				...
				<div class="mini-fit">
					...
					url="${pageContext.request.contextPath}/yue/tech/list" > 
		...
		function remove() {
			...
			if(row) {
				mini.confirm("删除当前记录，其子类（或技能）也即将删除，确定删除？", "确定？",
						function (action) {
							if (action == "ok") {
								$.ajax({
									'url': "${pageContext.request.contextPath}/yue/tech/delete?ids="+row.id,
									type: 'post',
									dataType:'JSON',
									cache: false,
									async:false,
		...
		function add() {
			...
			mini.open({
				url : "${pageContext.request.contextPath}/apps/default/admin/yue/tech/edit.jsp",
				title : "添加",
				width : 490,
				height : 250,
				onload : function() {
