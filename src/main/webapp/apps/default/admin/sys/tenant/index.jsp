...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="mini-splitter" style="width:100%;height:100%;">
			...
			<div showCollapseButton="true">
					...
					<table style="width:100%;">
						<tr>
							...
							<td style="white-space:nowrap;">
		                        <input id="key2" name="key2" class="mini-textbox" emptyText="请输入关键字" onclick="clearSearch()" style="width:150px;" onenter="search"/>   
				...
				<div class="mini-fit">
					...
					url="${pageContext.request.contextPath}/tenant/page"  idField="id" sizeList="[20,50,100,150,200]" pageSize="50" 
					 allowCellEdit="true" allowCellSelect="true" editNextOnEnterKey="true"  editNextRowCell="true" 
					>
					<div property="columns">
						<div type="checkcolumn" ></div>
						<div field="name" width="160" headerAlign="center" allowSort="true" align="left" >租户名称</div>
						<div field="code" width="80" headerAlign="center" allowSort="true" align="left">租户编码</div>
						...
						<div field="enable" type="comboboxcolumn" width="60" headerAlign="center" allowSort="true" align="center">是否启用
		...
		function remove() {
			...
			mini.confirm("确定删除？", "确定？",
				function (action) {
					if (action == "ok") {
						$.ajax({
							'url': "${pageContext.request.contextPath}/tenant/delete?ids="+ids.join(","),
							type: 'post',
							dataType:'JSON',
							cache: false,
							async:false,
		...
		function add() {
			mini.open({
				url : "${pageContext.request.contextPath}/apps/default/admin/sys/tenant/edit.jsp",
				title : "添加系统",
				width : 490,
				height : 220,
				onload : function() {
			...
			mini.confirm("确定导出记录？", "确定？",
		            function (action) {
		                if (action == "ok") {
							...
							var url = "${pageContext.request.contextPath}/tenant/export?exportFileType="+exportFileType+"&exportDataType="+exportDataType;
							location.href=url;
						}
					});
