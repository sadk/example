...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body> 
		<form id="edit-form1" method="post" style="height:97%; overflow:auto;">
			...
			<input name="value" id="value" class="mini-hidden" />
			...
			<div style="padding-left:11px;padding-bottom:5px;">
				<fieldset style="border:solid 1px #aaa;padding:3px; margin-bottom:5px;">
		            ...
		            <div style="padding:5px;">
				        <table>
							<tr>
								<td style="width:100px;">国/省/市/区：</td>
								<td style="width:150px;">
								 	<input name="name" id="name" class="mini-textbox"  />
								</td>
								<td style="width:100px;" align="right">序号：</td>
								<td style="width:150px;">
									<input name="sn" id="sn" class="mini-spinner" value="0" minValue="-99999999" maxValue="999999999"  />
								</td>
							</tr>
							<tr>
								<td>所属系统：</td>
		...
		<script type="text/javascript">
	        ...
	        function onButtonEdit(e) {
	            var btnEdit = this;
	            mini.open({
	                url: "${pageContext.request.contextPath}/apps/default/admin/sys/region/seletor_region.jsp",
	                title: "选择列表",
	                width: 650,
	                height: 380,
			...
			function SaveData() {
				...
				//if(true) return ;
				$.ajax({
					url : "${pageContext.request.contextPath}/region/save_or_update",
					dataType: 'json',
					type : 'post',
					cache : false,
					data: form.getData(),
			...
			function SetData(data) {
				data = mini.clone(data); //跨页面传递的数据对象，克隆后才可以安全使用
				 ...
				 if(data.action == "edit" || data.action=='view') {
					$.ajax({
						url : "${pageContext.request.contextPath}/region/page?id=" + data.id,
						dataType: 'json',
						cache : false,
						success : function(text) {
