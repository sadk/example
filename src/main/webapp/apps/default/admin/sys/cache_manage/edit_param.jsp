...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body> 
		<form id="edit-form1" method="post" style="height:97%; overflow:auto;">
			...
			<input id="cacheId" name="cacheId" class="mini-hidden" />
		...
		<script type="text/javascript">
			...
			var cacheIdHid = mini.get("cacheId");
			var cacheId = null;
			...
			function SaveData() {
				...
				$.ajax({
					url : "${pageContext.request.contextPath}/cache_url_param/save_or_update",
					dataType: 'json',
					type : 'post',
					cache : false,
					data: o,
			...
			function SetData(data) {
				...
				if(data.action == 'add') {
					cacheIdHid.setValue(data.cacheId);
				}				
				 if(data.action == "edit") {
					$.ajax({
						url : "${pageContext.request.contextPath}/cache_url_param/get_by_id?id=" + data.id,
						dataType: 'json',
						cache : false,
						success : function(text) {
