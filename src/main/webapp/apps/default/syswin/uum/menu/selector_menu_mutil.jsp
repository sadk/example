...
<body>
    ...
    <div class="mini-fit">
    	...
    	treeColumn="name" idField="id" parentField="pid" resultAsTree="false"  checkRecursive="true"  showCheckBox="true"  multiSelect="true" 
		url="${pageContext.request.contextPath}/syswin/menu/all_selector?idNotIn=${param.idNotIn}" > 
		    <div property="columns">
		        ...
		        <div field="nodePath" width="160" align="left">结点路径</div>
		        ...
		        <div name="id" field="id" width="50" >ID</div>
		        <div name="pid" field="pid" width="50" >父ID</div>              
		    </div>
		</div>
    </div>                
	...
	<script type="text/javascript">
	    ...
	    function GetData() {
	    	var data = grid.getCheckedNodes(true); // 等于true表示：含父节点
