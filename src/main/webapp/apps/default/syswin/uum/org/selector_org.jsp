...
<body>
    ...
    <div class="mini-fit">
		...
		url="${pageContext.request.contextPath}/syswin/org/list?idNotIn=${param.idNotIn}" > 
		    <div property="columns">
		        <div type="checkcolumn"></div>
		        <div name="name" field="name" width="220" >全称</div>
		        <!-- 
		        ...
		        <div field="appCode" width="60" align="right">所属应用</div>
		         -->
		        <div field="nodePath" width="150" align="left">结点路径</div>
		        <div name="id" field="id" width="60" >ID</div>
		        <div name="pid" field="pid" width="60" >父ID</div>   
		        <div field="sn" width="60" align="right">排序号</div>
