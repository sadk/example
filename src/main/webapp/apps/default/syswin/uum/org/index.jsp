...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
					...
					<table style="width:100%;">
						<tr>
							<td style="width:100%;">
								...
								<a class="mini-button" iconCls="icon-date" onclick="fillNodePathText()">填充节点导航</a>
								<!-- 
		...
		function fillNodePathText() {
			$.ajax({
				'url': "${pageContext.request.contextPath}/syswin/org/fill_node_path_text",
				type: 'post',
				dataType:'JSON',
				cache: false,
				async:false,
		...
		function repairNodePath() {
			$.ajax({
				'url': "${pageContext.request.contextPath}/syswin/org/repair_node_path",
				type: 'post',
				dataType:'JSON',
				cache: false,
				async:false,
