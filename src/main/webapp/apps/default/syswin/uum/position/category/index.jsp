...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="mini-splitter" style="width:100%;height:100%;">
			...
			<div showCollapseButton="true">
				...
				<div class="mini-fit">
					...
					showTreeIcon="true" allowResize="true" expandOnLoad="true" multiSelect="false" showpager=true
		...
		function edit(action) {
			...
			mini.open({
				url : "${pageContext.request.contextPath}/apps/default/syswin/uum/position/category/edit.jsp",
				title : "编辑分类信息",
				width : 490,
				height : 250,
				onload : function() {
		...
		function repairNodePath() {
			$.ajax({
				'url': "${pageContext.request.contextPath}/syswin/position_category/repair_node_path",
				type: 'post',
				dataType:'JSON',
				cache: false,
				async:false,
			...
			if(row) {
				mini.confirm("删除当前分类，其子分类也即将删除，确定删除？", "确定？",
						function (action) {
							if (action == "ok") {
								$.ajax({
									'url': "${pageContext.request.contextPath}/syswin/position_category/delete?ids="+row.id,
									type: 'post',
									dataType:'JSON',
									cache: false,
									async:false,
