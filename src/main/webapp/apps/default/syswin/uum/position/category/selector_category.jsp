...
<body>
    ...
    <div class="mini-fit">
    	...
    	treeColumn="name" idField="id" parentField="pid" resultAsTree="false"  checkRecursive="true"  showCheckBox="false"  multiSelect="false" 
		url="${pageContext.request.contextPath}/syswin/role_category/list?idNotIn=${param.idNotIn}" > 
