...
<div class="mini-splitter" style="width:100%;height:90%;">
    <div size="240" showCollapseButton="true">
        ...
        <div class="mini-fit">
            <ul id="tree1" class="mini-tree" url="${pageContext.request.contextPath}/syswin/role_category/list" style="width:100%;"
  			...
  			<div title="角色列表" >
		        ...
		        <div class="mini-fit" >
		            <div id="grid1" class="mini-datagrid" style="width:100%;height:100%;" multiSelect="true" 
		                borderStyle="border:0;"  url="${pageContext.request.contextPath}/syswin/role/page"
