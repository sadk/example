		...
		<div class="mini-splitter" style="width:100%;height:100%;">
			...
			<div showCollapseButton="true">
				...
				<div class="mini-fit">
					...
					url="${pageContext.request.contextPath}/machine/page"  idField="id" sizeList="[20,50,100,150,200]" pageSize="50" >
					<div property="columns">
						<div type="checkcolumn" ></div>
						<div field="code"  width="160" headerAlign="center" allowSort="true" align="center">服务器编码</div>
						<div field="appCode"  width="160" headerAlign="center" allowSort="true" align="center"></div>
						<div field="name"  width="160" headerAlign="center" allowSort="true" align="center">服务器名称</div>
						<div field="userName"  width="160" headerAlign="center" allowSort="true" align="center">登陆名称</div>
						<div field="userPassword"  width="160" headerAlign="center" allowSort="true" align="center">登陆密码</div>
						<div field="url"  width="160" headerAlign="center" allowSort="true" align="center">链接url</div>
						<div field="status"  width="160" headerAlign="center" allowSort="true" align="center">数据源状态：1=可用 0=不可用</div>
						<div field="address"  width="160" headerAlign="center" allowSort="true" align="center">地址,可以是ip也可以是域名</div>
						<div field="port"  width="160" headerAlign="center" allowSort="true" align="center">端口</div>
		...
		function remove() {
			...
			mini.confirm("确定删除？", "确定？",
				function (action) {
					if (action == "ok") {
						$.ajax({
							'url': "${pageContext.request.contextPath}/machine/delete?ids="+ids.join(","),
							type: 'post',
							dataType:'JSON',
							cache: false,
							async:false,
			...
			mini.confirm("确定导出记录？", "确定？",
		            function (action) {
		                if (action == "ok") {
							...
							var url = "${pageContext.request.contextPath}/machine/export?exportFileType="+exportFileType+"&exportDataType="+exportDataType;
							location.href=url;
						}
					});
